        ...
        execute: function () {
            exports_1("HamburgerMenu", HamburgerMenu = () => {
                ...
                const primaryMenuItems = [
                    ...
                    { icon: lucide_icons_1.Camera, label: '投稿作成', route: '/post' }, // 投稿作成画面
                    { icon: lucide_icons_1.History, label: '投稿履歴', route: '/history' }, // 投稿一覧・履歴
                    { icon: lucide_icons_1.User, label: 'プロフィール', route: '/profile' }, // 農家さん情報など
                    { icon: lucide_icons_1.Settings, label: '設定', route: '/settings' }, // Instagram連携など
                ];
